...
public interface Operations {
    ...
    public static final int GET_ALL_KONSULTANT = 1;
    ...
    public static final int GET_ALL_USLUGA = 11;

    public static final int GET_ALL_MARKETINSKA_AGENCIJA = 12;

    public static final int GET_ALL_TERMIN_KLIJENTA = 13;
}
