...
public class ServerForm extends javax.swing.JFrame {
     ...
     */
    private StartServerThread threadServer;
    ...
    private void initComponents()
    {
        ...
        lblServerStatus.setForeground(new java.awt.Color(0, 102, 153));
        lblServerStatus.setText("Server status");

        btnPokreniServer.setBackground(new java.awt.Color(255, 255, 255));
        btnPokreniServer.setForeground(new java.awt.Color(0, 102, 255));
        ...
        btnUgasiServer.setBackground(new java.awt.Color(255, 255, 255));
        btnUgasiServer.setForeground(new java.awt.Color(0, 102, 255));
	...
	{
	    threadServer = new StartServerThread();
            threadServer.start();
	...
	new DBConfiguration(this, true).setVisible(true);
    ...
    private void btnUgasiServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUgasiServerActionPerformed
		...
		JOptionPane.showMessageDialog(this, "Ćao! Vidimo se uskoro :)");
                this.dispose();
                System.exit(0);
